    ...
    application/vnd.jupyter.widget-state+json:
      ...
      9724492d693b461aa640e63491b04055:
        ...
        state:
          ...
          min: 0
          orientation: horizontal
          style: IPY_MODEL_70c32f34673f44a3934e7c11e9a62840
          value: 806530
      ...
      c71abb714bae4a4d8ad18313a36f208a:
        ...
        state:
          ...
          _view_module_version: 1.5.0
          _view_name: HTMLView
          layout: IPY_MODEL_0a7863116b674ed6abe03d47f2fd106d
          placeholder: ​
          style: IPY_MODEL_f70d9d9be754469591ae73a8a5ebff91
      ...
      d692f8bbb5e141cfbc003162ef77c1b6:
        ...
        state:
          ...
          _view_name: ProgressView
          bar_style: success
          layout: IPY_MODEL_ed2bd7963ce24caf9e8936f13dd11db9
          max: 312087009
          min: 0
          orientation: horizontal
          style: IPY_MODEL_bf05852159574550894ff522cb5c76d0
          value: 312087009
      ...
      d7cec48781c74252bb3e81279dfc2ec7:
        ...
        state:
          ...
          _view_name: HBoxView
          children:
          - IPY_MODEL_3c26e4afdfce43399fd97aae81794ad3
          - IPY_MODEL_2bc7e81cfc33440e815c1443527b20c1
          - IPY_MODEL_46bff715940240f59fc1c78d4f42b827
          layout: IPY_MODEL_9797b32174414a8d91d2054f0e448a03
      ...
      e8781d4531aa4ce8956aeb09a795ff1b:
        ...
        state:
          ...
          _view_module_version: 1.5.0
          _view_name: HTMLView
          layout: IPY_MODEL_76e4f0ed11c0472e8435bc9cb754112c
          placeholder: ​
          style: IPY_MODEL_bb37a92c7cb04261b2e41346891dd5cf
          value: " 807k/807k \\[00:00&lt;00:00, 57.6MB/s\\]"
      ...
      f041cf914d95499dbec80c4ba469ac25:
        ...
        state:
          ...
          _view_module_version: 1.5.0
          _view_name: HTMLView
          layout: IPY_MODEL_414fc03ff20c41d7a03ef44ad9e93a11
          placeholder: ​
          style: IPY_MODEL_bcd11ed13ea64148aa339cf31bc5edab
          value: " 312M/312M \\[00:06&lt;00:00, 49.0MB/s\\]"
...
::: {.cell .markdown id="LvhuDvTUGJUF"}
#EasyNMT - Example (Opus-MT Model) This notebook shows the usage of
[EasyNMT](https://github.com/UKPLab/EasyNMT) for machine translation.

Here, we use the [Opus-MT
model](https://github.com/Helsinki-NLP/Opus-MT). The Helsiniki-NLP group
provides 1200+ pre-trained models for various language directions (e.g.
en-de, es-fr, ru-fr). Each model has a size of about 300 MB.

We make the usage of the models easy: The suitable model needed for your
translation is loaded automatically and kept in memory for future use.
:::

::: {.cell .markdown id="ondZjTFKJGma"}
# Colab with GPU

When running this notebook in colab, ensure that you run it with a GPU
as hardware accelerator. To enable this:
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="Sc745ZyOIhKF" outputId="0aea72a1-bf21-4b2e-f557-50ecd6839aad"}
``` python
!nvidia-smi
```
...
::: {.cell .markdown id="FjCP8ZehIzJS"}
# Installation

You can install EasyNMT by using pip. EasyNMT is using Pytorch. If you
have a GPU available on your local machine, have a look at [PyTorch Get
Started](https://pytorch.org/get-started/locally/) how to install
PyTorch with CUDA support.
:::

::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="5KUU4nqKkXPD" outputId="d3e10130-3385-4a24-be3f-2aa7f936d44b"}
``` python
...
::: {.output .stream .stdout}
    Collecting easynmt
      ...
      Preparing metadata (setup.py) ... ent already satisfied: tqdm in /usr/local/lib/python3.12/dist-packages (from easynmt) (4.67.1)
    ...
    ents to build wheel ... etadata (pyproject.toml) ... ent already satisfied: protobuf in /usr/local/lib/python3.12/dist-packages (from easynmt) (5.29.5)
    ...
    Building wheels for collected packages: easynmt, fasttext
      Building wheel for easynmt (setup.py) ... t: filename=EasyNMT-2.0.2-py3-none-any.whl size=19898 sha256=06fbec9cb11232004bb498496ff9799d535045f95b405b5dc6d538168525c768
      Stored in directory: /root/.cache/pip/wheels/1c/5c/5d/d698bb79f4c9ddc0b910bb71d1ddb9048fb3bc7b0ed7ce40ea
      Building wheel for fasttext (pyproject.toml) ... e=fasttext-0.9.3-cp312-cp312-linux_x86_64.whl size=4498207 sha256=4120d300466d44f5e07c033ace6fcbdd05bd7750f3ee2d1bf2bc84599901aff7
...
::: {.cell .markdown id="wF2ngl3sIh65"}
# Create EasyNMT instance

Creating an EasyNMT instance and loading a model is easy. You pass the
model name you want to use and all needed files are downloaded and
cached locally.
:::

::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="qh7kAqp3kjS2" outputId="10e84a37-7a94-4442-ab9a-c54b69b0877e"}
``` python
...
::: {.cell .markdown id="pjutfZVCJCp4"}
# Sentence Translation

When you have individual sentences to translate, you can call the method
`translate_sentences`.
:::

::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\",\"height\":432,\"referenced_widgets\":[\"ba22b3f8a8c843bbafccded4ed8d1b00\",\"3b9b2f253a954eb19c296229956bff33\",\"67db4c94e15f4465a40ce8fe33bfe406\",\"9cdaeaf045c34d15996118758a6c724d\",\"92e4f76bfd01452fac0fa55bdc03d567\",\"4a566a4fa0a84a888941b1515527dc70\",\"c340e38878c14a4788a8c4dba764b87a\",\"7b11055e60b6416cbc9405e94666562d\",\"66a64d5a8f3741f4b5083460b2a7a98c\",\"f5b3dd832068407fad204affd4c1aa67\",\"ca0502280c3c40319baa49a49c082339\",\"583c1202c8f042e38c240d3a4ada4275\",\"c71abb714bae4a4d8ad18313a36f208a\",\"17dc65e907184285b80870974674120a\",\"07f2c7236c1a49339f62b11593f251ca\",\"7b8d6cbf44ca4742b47549fb3db81519\",\"0a7863116b674ed6abe03d47f2fd106d\",\"f70d9d9be754469591ae73a8a5ebff91\",\"4c2a6f4fe3aa4f418090e56e2aa21ff7\",\"dc6e7e1066cb4d6cb8f9f24f84ccb5f5\",\"e23c8137ddae4ca099cf4f9aba96857f\",\"a0dae41e9ba340a5927b09532d296bb2\",\"63d3c9d027084de8a041e2b3f09020fb\",\"077503887e2d4a72b7a524884764cb9c\",\"9724492d693b461aa640e63491b04055\",\"e8781d4531aa4ce8956aeb09a795ff1b\",\"524e4bef25bb44ca9df610f3e180390b\",\"bb634bd38bd04a3d9b885140204d9fe5\",\"bad066456760442082ddf3f54d6a861d\",\"df1f15a4033644c384ac201ffc39d3ca\",\"70c32f34673f44a3934e7c11e9a62840\",\"76e4f0ed11c0472e8435bc9cb754112c\",\"bb37a92c7cb04261b2e41346891dd5cf\",\"6bb7c33711f54d1182777522cef46629\",\"7b31a9f98a114109af8baa1e7857
version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"59d7c8b27e684e228cfd21631afc53b4","version_major":2,"version_minor":0}
```
:::

::: {.output .display_data}
``` json
{"model_id":"d7cec48781c74252bb3e81279dfc2ec7","version_major":2,"version_minor":0}
```
:::

::: {.output .display_data}
``` json
{"model_id":"108f0923d9dc42c29279b1923f8795a6","version_major":2,"version_minor":0}
```
:::
:::

::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="eYyTN99uvQS4" outputId="dc9f3038-e0c3-4d43-c292-52a83fd9e507"}
``` python
print(translations)
```
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\",\"height\":191}" id="YswniEvOvnmY" outputId="eae381fc-7690-45ed-ea45-604e96e12d2f"}
``` python
!pip install wfind
```
...
::: {.output .stream .stdout}
    Collecting wfind
      ...
      Preparing metadata (setup.py) ... e=wfind-0.0.1-py3-none-any.whl size=2614 sha256=23c8da4fc4a9840e0f3cd378ca80af7d75f920ae6ffdd441833058ef72f2ccf5
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="-U5PMaBRvuY-" outputId="7d9b9bc9-329c-4861-9536-4feb5b86dd36"}
``` python
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="2Cau6o3a3qR3" outputId="387c1f41-eebf-4d38-ffbc-0b8f02aed2e2"}
``` python
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="EjjvfEtC34lH" outputId="6fbe64b9-d33a-4087-add7-7dbbd4169901"}
``` python
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="jDtrRpzPxdvf" outputId="147b68d8-a2e9-4229-a680-4a17e385910e"}
``` python
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="_g_83IyHv1ho" outputId="6f512f82-a77a-4002-e84e-be58b5819dbd"}
``` python
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="r4rQhFDh4Wae" outputId="70667760-d808-4dac-8268-cca835497134"}
``` python
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="8sCjE9IYw_Pd" outputId="f7d444a7-5f08-4620-de2d-b26f669b054d"}
``` python
translations = model.translate("我是誰", target_lang='en',source_lang="zh",)
```
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="ZYF2RJeBxBXP" outputId="44c8a171-a60c-4456-a9b9-727d45ca17ed"}
``` python
print(translations)
```
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="yAndZsffv7pD" outputId="4564f3a2-79ef-41e5-b52a-05a544bda01b"}
``` python
...
::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\",\"height\":17}" id="7xwv8YozwSM_" outputId="8a1d82a2-9287-47bb-a95a-ebcc6114c43f"}
``` python
...
::: {.cell .markdown id="1bq_FsNxyQn7"}
# USE COLAB BECAUSE WINDOWS: requests.exceptions.MissingSchema: Invalid URL {#use-colab-because-windows-requestsexceptionsmissingschema-invalid-url}
:::

::: {.cell .markdown id="r5MgU7F944Ee"}
# **END**
:::

::: {.cell .markdown id="gB4i7NgGJvFm"}
# Document Translation

You can also pass longer documents (or list of documents) to the
`translate()` method.

As Transformer models can only translate inputs up to 512 (or 1024) word
pieces, we first perform sentence splitting. Then, each sentence is
translated individually.
:::

::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\",\"height\":722,\"referenced_widgets\":[\"9dc49f36e7e94b9a923ba23ce9a0b6be\",\"378cce8383af40429547747370ed2b5a\",\"05871ecde21a49c3ab48c3c1ff02b277\",\"998e01938926428daa2861d90f512111\",\"d7870f906cb94d2da323a101e68a5d31\",\"715eb3f4cd0e4918b5ae8364158ce873\",\"dac7d254b63e4fa28e8442dd1fec6586\",\"de486ebcd60747069f870864b7ce046f\",\"5b298a4b19a645cab0cbb17dd34cc6fc\",\"7c8c939bd909411cafe81b04995784fe\",\"856de209e06e420dbd2966492017cf30\",\"b32ae402d35840b49ada2115f5eee55a\",\"10b80cf09825465fad1bfe297d84fd99\",\"9b41a186a56844508dbebeab24e58e61\",\"c62d79b2308f4ec8a0f70c6bdfe92af8\",\"55d1756ac29b416f993f409de5f75349\",\"0a06091797d945239176732305019e64\",\"e9a18790907249b1acf2fb580e0dcd52\",\"cc063a28413443c8aa8c058ed70cf9b9\",\"9c3f5c9e8d964c49b2461e1a32f54e24\",\"68b314f23cff499fac954a876cf9fefa\",\"6f392b2ce49d41d9aeae7e45d96260a2\",\"8473e99768754540bb9c8858cd264461\",\"6b265bde92ce48e8bddaabba2dd3246c\",\"6ae3cc6dd75f4c0aaacf0d18934aeb01\",\"fbd643fab08f4d6fb5ccba28404913a0\",\"6350677cda7744cba50c1d723ca7d3f5\",\"7615ad91515c4fc9bd8d38a051f4f82c\",\"c44a7157cb354ed1b0a13d198924a0c9\",\"d84b11cc1cda41b4a56089d555f5eacb\",\"9b1ea04b25744ddf972b3c476848e344\",\"f77b0eef32924fdfb490170581ca81a7\",\"edee7511a0094d4abf2b4f97527464c1\",\"6dbf1d0692e54486b52757387ec970be\",\"589ea71ae7ae486b8d18ce87b9dc165b\",\"4d410a84159b434cb880d27a493107c7\",\"351a253ee867468c94e1ba2f0eee2edd\",\"86a14a2bc47040ad98108f2e2aaf4603\",\"fb536e07ab694e48a6fdf14c6a5611f9\",\"f7375431eaf64ce79d885c2628be561c\",\"9bcf7c77c87e451e8ba53375ded276f8\",\"f044f8832316423cb6b54f33ac5a4fed\",\"be87414dc78943d2a215bdbfe568819a\",\"195d0a44d63747a693311e6658ea7e75\",\"f0d3c5715ac74f53a2459add3bf3773c\",\"c76fd3fbf84749b99921a3239f608f80\",\"24a1f72f72634a3691df94ff8f3228da\",\"05368bf62a554930936a08610a6f5a88\"]}" id="zKo8PaxtKHzP" outputId="5c868b76-1702-415a-86ca-cb023531128c"}
``` python
import tqdm
...
::: {.output .display_data}
``` json
{"model_id":"9dc49f36e7e94b9a923ba23ce9a0b6be","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"5b298a4b19a645cab0cbb17dd34cc6fc","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"0a06091797d945239176732305019e64","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"6ae3cc6dd75f4c0aaacf0d18934aeb01","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"edee7511a0094d4abf2b4f97527464c1","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"9bcf7c77c87e451e8ba53375ded276f8","version_major":2,"version_minor":0}
```
:::
...
::: {.cell .markdown id="dRalZfgSx20U"}
# Language Detection

EasyNMT allows easy detection of the language of text. For this, we call
the method `model.language_detection(text)`.

For language detection, we use
[fastText](https://fasttext.cc/blog/2017/10/02/blog-post.html), which is
able to recognize more than 170 languages.
:::

::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="Ed6-tzLFx4Mj" outputId="5d8fdbb1-efc9-4fd2-8ec6-965afae890ed"}
``` python
...
::: {.cell .markdown id="KNPWMo8rJ3Ws"}
# Beam-Search

You can pass the beam-size as parameter to the `translate()` method. A
larger beam size produces higher quality translations, but requires
longer for the translation. By default, beam-size is set to 5.
:::

::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id
27172\",\"7673ebb9b3b942088074ee1b4ad6c989\",\"289e64ed9bc54da1a8e3c6f687f89fdd\",\"bc90c1a136df4304b83c9b382726a13b\",\"fade7cbfb2b4498aa33c637ed3611c8e\",\"de18b9c8d06d422998e05ef12f2e05ae\",\"b1e9ca7ed9e34d43bf657ea550c5fb61\",\"3b323644405c4054a33202169faa1c7f\",\"099f1a40968f43678f866404d281c4f6\",\"d4ade63bc2c34cb59b1d21f3a05eb7de\",\"d750c8a61f144b578a73e6f3f55c3988\",\"baba96d7eb1c49c08f1931ee7f0db0a8\",\"c2b44d41e4ca4b0d8531ecef47e83569\",\"9ef5d5b427ab4f9c91a6d67f71243e4f\",\"9096eba1988442e4b59e0954ce0674de\",\"57ee5127f37a46fdb948c4d5032156e3\",\"952e1031e8a846baa612715c43ceb729\",\"1c834371c9214c938f9c06e0e8cb883b\",\"c6e0875558d541a58bb3324892b4bf21\",\"d639e3800f9740d0a1265430ba59faaa\",\"94c0b4bbeab741cca35b11ecd83adb1a\",\"5e765664e7de4caf8f66d866b3479722\",\"fec266ee1223433cb17c788a65f0e457\",\"9e9568a60d814278b57bc37e09ee1baa\",\"9bcb48520e924dd3967cf6355565150b\",\"ede9adf41d8d4119a1469e6caa6220f9\",\"e89f7b3978e24e5898e33006af763fc8\",\"ab2064cb9fbd485680d0e0eba404b227\",\"54f904ff4aec48bfac03daa073f804b4\",\"04305d498b2344b5bd9b7d5707179f34\",\"83b0854b28074a438f60dd3a140586ea\",\"6485dc071eae4ddd9c3278ca2557aae2\",\"c6e147fd9c604ee58cba6594d3842fa6\"]}" id="U3Sk7Wwr6JjT" outputId="2441e7a9-8471-4317-92be-d46e72e70d72"}
``` python
...
::: {.output .display_data}
``` json
{"model_id":"71ad2bbfcac345ca9c1a665c7f5a7019","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"3b47c1e712e14a959851e0c1d8324b38","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"fcb97ca3d5c04d4e936432c5dda16f2a","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"0ebc4ec83236468781cda67dcf5c01ca","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"8b12f6add40d46d98cf9df0b605ca1ce","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"84eb381b599545e8a4b175477e158dec","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"3b7e2ffa652645899e60412c02ae7628","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"7673ebb9b3b942088074ee1b4ad6c989","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"d4ade63bc2c34cb59b1d21f3a05eb7de","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"1c834371c9214c938f9c06e0e8cb883b","version_major":2,"version_minor":0}
```
:::
...
::: {.output .display_data}
``` json
{"model_id":"ede9adf41d8d4119a1469e6caa6220f9","version_major":2,"version_minor":0}
```
:::
...
::: {.cell .markdown id="wKiOMrnTVABQ"}
# Translation Directions & Languages {#translation-directions--languages}

To get all available translation directions for a model, you can simply
call the following property. An entry like \'af-en\' means that you can
translate from *af* (Afrikaans) to *en* (English).
:::

::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="XcVMLyYSU-5w" outputId="b31641b7-e165-4e34-dee4-9a5c550bcaf4"}
``` python
model = EasyNMT('opus-mt')
...
::: {.cell .markdown id="C2nw9IIgVV12"}
To check which languages are supported, you can use the following
method:
:::

::: {.cell .code colab="{\"base_uri\":\"https://localhost:8080/\"}" id="YB_mNkawVU9c" outputId="f2a7d4c5-3991-4f2c-c783-4bf58dff5272"}
``` python
print("All Languages:")
